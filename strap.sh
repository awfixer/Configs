...
sudo pacman -Syu archlinux-tweak-tool-dev-git obs-studio vivaldi wine wine-mono discord-update-skip-git kate qemu-full virt-manager gnome-boxes flatpak flatpak-kcm nix nix-init flatpak-builder nix-docs flatpak-docs pacseek yay thorium-browser-bin vim --noconfirm
